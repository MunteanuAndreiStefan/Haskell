...
executaInstr valuatie (For e1 e2 e3 p) = case (evalp e1 valuatie) of
                                           Nothing -> Nothing
                                           Just 0 -> Just valuatie
                                           otherwise -> case (evalp e2 valuatie) of
                                                        Nothing -> Nothing
                                                        otherwise -> case (executaProgram valuatie p) of
                                                                      Nothing -> Nothing
                                                                      Just valuatie' -> executaInstr valuatie' (For e1 e2 e3 p)
...
prog3 = [Atrib "n" (Numar 10),
         Atrib "s" (Numar 0),
         For ((Var "n"),(Var "n"),(Atrib "n" (Diferenta (Var "n") (Numar 1)))) [Atrib "s" (Suma (Var "s") (Var "n"))],
         Atrib "result" (Var "s")]
{-

Exercitiul 4

Adaugati instructiunea "for"; nu uitati sa testati pe cateva exemple.
